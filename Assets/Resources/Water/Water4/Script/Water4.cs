...
public class Water4 : MonoBehaviour
{
    ...
    void OnDrawGizmos()
    {
        ...
        if (render != null)
        {
            ...
            //  render.materials[0].mainTextureScale = new Vector2((transform.localScale.x / 60) * (12.2f / transform.localScale.y), 1);



            render.sharedMaterials[0].mainTextureScale = new Vector2((transform.localScale.x / 60) * (12.2f / transform.localScale.y), 1);
